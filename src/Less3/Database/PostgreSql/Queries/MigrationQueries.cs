namespace Less3.Database.PostgreSql.Queries
{
    ...
    internal static class MigrationQueries
    {
        internal static List<string> GetMigrations()
        {
            ...
            migrations.Add("ALTER TABLE objects ADD COLUMN IF NOT EXISTS expirationutc TIMESTAMPTZ;");
            ...
            migrations.Add("ALTER TABLE requesthistory ADD COLUMN IF NOT EXISTS requestbody TEXT;");
            migrations.Add("ALTER TABLE requesthistory ADD COLUMN IF NOT EXISTS responsebody TEXT;");
