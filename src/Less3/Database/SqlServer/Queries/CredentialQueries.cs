namespace Less3.Database.SqlServer.Queries
{
    ...
    internal static class CredentialQueries
    {
        ...
        {
            return "SELECT TOP 1 * FROM credential WHERE guid = '" + Sanitizer.SanitizeString(guid) + "';";
        }
        ...
        {
            return "SELECT TOP 1 * FROM credential WHERE accesskey = '" + Sanitizer.SanitizeString(accessKey) + "';";
        }
